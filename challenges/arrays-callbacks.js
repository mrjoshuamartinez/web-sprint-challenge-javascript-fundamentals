...
const lowCaseAnimalNames = zooAnimals.map((items) => {
  // each string following this pattern: "jackal, asiatic". 
...
// Find the total population from all the zoos
let populationTotal = 0;

// using the .reduce() method   --  callback (which itself takes two args), and an initial value for the count.
populationTotal = zooAnimals.reduce((totalAnimals, item) =>{
